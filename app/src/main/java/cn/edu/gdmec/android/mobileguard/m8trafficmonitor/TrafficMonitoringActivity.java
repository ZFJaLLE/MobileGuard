...
public class TrafficMonitoringActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initData(){
        ...
        mUsedTV.setText("本月已用" + Formatter.formatFileSize(this,totalflow));
    ...
    private  void registReceiver(){
        ...
        filter.addAction("android.provide.Telephony.SMS_RECEIVED");
    ...
    public void onClick(View v){
      switch (v.getId()){
          ...
          case R.id.btn_correction_flow:
              ...
              switch (i){
                  case 0:
                      Toast.makeText(this,"您还没有运营商信息" , 0).show();;
                      break;
                  case 1:
                      //中国移动
                      //发送cxll至10086
