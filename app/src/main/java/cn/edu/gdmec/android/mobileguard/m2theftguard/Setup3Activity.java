...
public class Setup3Activity extends BasicSetUpActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String safephone = sp.getString("fafephone",null);
    ...
    protected void  onActivituResult(int requestCode ,int resultCode,Intent data){
